...
(function (O, W, u) {
        ...
        cb("ng", ["ngLocale"], ["$provide", function (a) {
            ...
            a.provider("$compile",
                Cc).directive({
                    ...
                    ngValue: Me,
                    ngModelOptions: Ne
                }).directive({ngInclude: Oe}).directive(pb).directive(Ic);
            a.provider({
                $anchorScroll: Pe,
                $animate: Qe,
                $$animateQueue: Re,
            ...
            "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function (a, b, c, d, t, p, x, q, I, A, M) {
                ...
                function J(a, b, d, e, f, g, h, k, m) {
                    ...
                    for (var P = -Number.MAX_VALUE, M, ba = m.controllerDirectives, t = m.newIsolateScopeDirective, C = m.templateDirective, n = m.nonTlbTranscludeDirective,
                        ...
                        if (J.templateUrl)I = !0, O("template", C, J, X), C = J, J.replace && (g = J), N = Jf(a.splice(K, a.length - K), X, d, f, x && Ha, h, k, {
                            controllerDirectives: ba,
                            newIsolateScopeDirective: t,
                            templateDirective: C,
                            nonTlbTranscludeDirective: n
                        }), F = a.length; else if (J.compile)try {
    ...
    function $e() {
        var b = this.defaults = {
            transformResponse: [Zb], transformRequest: [function (a) {
                ...
                common: {Accept: "application/json, text/plain, */*"}, post: fa($b),
                put: fa($b), patch: fa($b)
                    ...
                    do {
                        ...
                        a:do {
                            if (k = z.$$watchers)for (m = k.length; m--;)try {
                                if (b = k[m])if ((f = b.get(z)) !== (h = b.last) && !(b.eq ? ka(f, h) : "number" === typeof f && "number" === typeof h && isNaN(f) && isNaN(h)))s = !0, d = b, b.last = b.eq ? ua(f, null) : f, b.fn(f, h === q ? f : h, z), 5 > n && (I = 4 - n, t[I] || (t[I] = []), t[I].push({
    ...
    n({
        data: Vb, inheritedData: xb, scope: function (b) {
    ...
    var Xc = /^((?:x|data)[\:\-_])/i, Lf = K("$controller"), Vc = /^(\S+)(\s+as\s+(\w+))?$/, ad = "application/json", $b = {"Content-Type": ad + ";charset=utf-8"}, Nf = /^\[|^\{(?!\{)/, Of = {
        "[": /]$/,
        "{": /}$/
    ...
    q.prototype = {
        ast: function (a) {
            ...
            "true": {type: q.Literal, value: !0}, "false": {type: q.Literal, value: !1}, "null": {
                type: q.Literal,
                value: null
            }, undefined: {type: q.Literal, value: u}, "this": {type: q.ThisExpression}
        }
    };
    pd.prototype = {
    ...
    var Md = function (a) {
            return ["$timeout", function (c) {
                return {
                    name: "form", restrict: a ? "EAC" : "E", controller: Ed, compile: function (d, e) {
    ...
    var we = ["$animate", function (a) {
        ...
        Ke = function () {
            ...
            function d(a, d, e) {
                ...
                return {
                    trackBy: q, getTrackByValue: p, getWatchables: c(A, function (a) {
                        var c = [];
                        a = a || [];
            ...
            return {
                restrict: "E", require: ["select", "?ngModel"], controller: zg, link: function (a, c, d, e) {
                    var f = e[1];
                    if (f) {
                        var g = e[0];
                        g.ngModelCtrl = f;
