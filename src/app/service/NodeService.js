...
NodeService.IconRegExp = /^Icon:\s*(.*)/;
NodeService.defaultIconConfig = { project: 'list', task: 'yes', nextaction: 'bookmark', done: 'button_ok' };
NodeService.iconConfig = { project: 'list', task: 'yes', nextaction: 'bookmark', done: 'button_ok' };
